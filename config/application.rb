...
module Chatwoot
  class Application < Rails::Application
    ...
    # BEGIN: Adicionado para carregar o serviço de licenciamento StackLab
    # Adiciona o diretório 'stacklab' na raiz do projeto aos caminhos de autoload.
    # Isso permite que classes e módulos dentro de 'stacklab/' (como Stacklab::LicensingService)
    # sejam carregados automaticamente pelo Rails.
    config.autoload_paths << Rails.root.join('stacklab')
    # END: Adicionado para carregar o serviço de licenciamento StackLab
