Rails.application.routes.draw do
      ...
      resources :accounts, only: [:create, :show, :update] do
        ...
        scope module: :accounts do
          ...
          resources :inboxes, only: [:index, :show, :create, :update, :destroy] do
            ...
            get :generate_qrcode, on: :member
            put :restart_instance, on: :member
            get :connection_state, on: :member
            delete :logout_instance, on: :member
            get :server_url, on: :member
          ...
          resources :kanban_items, only: [:index, :show, :create, :update, :destroy] do
            ...
            member do
              ...
              # Novas funcionalidades de timer e checklist
              get :time_report
  ...
  devise_scope :super_admin do
    ...
    namespace :super_admin do
      ...
      resource :cloud_configs, only: [:show, :create]
      resource :dashboard_scripts, only: [:show, :create] do
        get :stacklab_ai, on: :member
        post :generate_script, on: :member
        post :update_logout_redirect, on: :member
      end
      get 'script_gallery', to: 'script_gallery#index', as: 'script_gallery'
      get 'script_gallery/raw/:script_name', to: 'script_gallery#raw_content', as: 'script_gallery_raw'
      get 'script_gallery/:script_name', to: 'script_gallery#show', as: 'script_gallery_show'
