...
ActiveRecord::Schema[7.2].define(version: 2026_01_14_201315) do
  ...
  create_table "accounts", id: :serial, force: :cascade do |t|
    ...
    t.jsonb "manually_managed_features"
...
# Could not dump table "article_embeddings" because of following ActiveRecord::StatementInvalid
#   PG::UndefinedFile: ERROR:  could not access file "$libdir/vector": No such file or directory
...
# Could not dump table "captain_assistant_responses" because of following ActiveRecord::StatementInvalid
#   PG::UndefinedFile: ERROR:  could not access file "$libdir/vector": No such file or directory
  ...
  create_table "funnels", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.jsonb "global_custom_attributes", default: [], null: false
  ...
  create_table "kanban_automations", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "name"], name: "index_kanban_automations_on_account_id_and_name"
    t.index ["account_id"], name: "index_kanban_automations_on_account_id"
  end

  create_table "kanban_configs", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.jsonb "config", default: {}, null: false
    t.boolean "enabled", default: true
    t.string "webhook_url"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id"], name: "index_kanban_configs_on_account_id"
    t.index ["config"], name: "index_kanban_configs_on_config", using: :gin
    t.index ["webhook_events"], name: "index_kanban_configs_on_webhook_events", using: :gin
  end
  ...
  create_table "kanban_items", force: :cascade do |t|
    ...
    t.jsonb "assigned_agents", default: []
    ...
    t.index ["activities"], name: "index_kanban_items_on_activities", using: :gin
    t.index ["assigned_agents"], name: "index_kanban_items_on_assigned_agents", using: :gin
    t.index ["checklist"], name: "index_kanban_items_on_checklist", using: :gin
    t.index ["conversation_display_id"], name: "index_kanban_items_on_conversation_display_id"
    t.index ["funnel_id", "funnel_stage"], name: "index_kanban_items_on_funnel_id_and_funnel_stage"
    t.index ["funnel_id"], name: "index_kanban_items_on_funnel_id"
    t.index ["item_details"], name: "index_kanban_items_on_item_details", using: :gin
  end
  ...
  create_table "scheduled_messages", force: :cascade do |t|
    ...
    t.index ["status"], name: "index_scheduled_messages_on_status"
  ...
  add_foreign_key "kanban_configs", "accounts"
